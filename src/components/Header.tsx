          ...
          <nav className="flex gap-6 lg:gap-8 flex-1 justify-between items-center">
            ...
            <div className="hidden lg:flex items-center gap-4">
              ...
              <Link
                ...
                title="Newsletter"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="text-[#3e2a1f]"><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4Z"></path><path d="M3 6h18"></path><path d="M16 10a4 4 0 0 1-8 0"></path></svg>
              </Link>
            </div>
          </nav>
